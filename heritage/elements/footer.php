...
<div class="row">
    <div class="col-md-4">
     <?php
       ...
       $compteur_2=new DoubleCompteur(dirname(__DIR__) . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR .'compteur');
       $compteur->incrementer();
       $vues= $compteur->recuperer();
       $vues_double=$compteur_2->recuperer();       ?>
       il ya <?php echo $vues; ?> visites sur le site <br>
       il ya <?php echo $vues_double; ?> visites sur le site 
    </div>
    <div class="col-md-4">
